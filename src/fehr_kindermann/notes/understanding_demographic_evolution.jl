...
```math
N_{j,t} = \psi_{j,t}N_{j-1,t-1} \qquad \text{con} \qquad N_{1,t} =(1+n_{p,t})N_{1,t-1}
```

Los pesos de cada cohorte con respecto al corte inicial se definen como:
