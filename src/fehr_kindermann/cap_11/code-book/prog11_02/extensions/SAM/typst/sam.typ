...
#page(flipped: true, width: auto, height: auto)[
  ...
  #figure( 
    ...
    [Hogares], [],[$w_t L_t (1-tau_t^w)$],[$(r_t+delta) K_t  (1-tau_t^r)$],[$ overline("pen")_t sum_(j=j_r)^J m_j$ ],[],[],[],[],[],
    [Gobierno (Ingresos)], [],[$w_t L_t tau_t^w$],[$(r_t+delta) K_t tau_t^r$],[],[$tau_t^c C_t$],[],[],[],[],
    [Gobierno (Gasto)], [],[],[],[],[],[Gasto#footnote[Es igual al monto de impuestos recaudados, $T_t$, que desagregan en impuestos al consumo, al ingreso laboral y al capital, $tau_t^c C_t$, $tau_t^w w_t L_t$, $tau_t^r r_t A_t$, respectivamente. También puede calcularse con la fórmula $G_t + (1 +r_t )B_t – (1 +n_p)B_(t+1)$]],[],[],[],
