...
function solve_household(ij_in, it_in)
    ...
    beq[JJ, 1, it] = damp*GAM[JJ, 1, it]*BQ[it] + (1.0-damp)*beq[JJ, 1, it]#
    beq[JJ, 2, it] = damp*GAM[JJ, 2, it]*BQ[it] + (1.0-damp)*beq[JJ, 2, it]#
    ...
    for ij in JJ-1:-1:ij_in
        ...
        #bequest for the olds
        beq[JJ, ik, it] = damp*GAM[JJ, 1, it]*BQ[it] + (1.0-damp)*beq[JJ, ik, it]#
